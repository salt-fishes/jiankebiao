...
fun PrivacyPage(
    ...
    Scaffold(
        ...
        Column(
            ...
            PrivacySection("五、权限说明", "应用仅在导入课表时使用系统文件选择器读取您主动选择的 PDF / Excel 文件；通过系统分享面板接收课表文件时，仅读取分享方主动提供的文件内容；导出 .ics 日历文件时使用系统保存对话框写入您指定位置。申请通知权限用于显示解析进度与上课提醒，不涉及位置、通讯录、存储等其他权限。", glass)
            PrivacySection("六、联系我们", "如您对本隐私政策有任何疑问，请联系：xunguang255@163.com", glass)
            PrivacySection("七、政策更新", "本政策如有更新，将在应用内「关于」页面展示最新版本。更新日期：2026-09-03", glass)
